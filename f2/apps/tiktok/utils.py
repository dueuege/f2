...
# 通用字段名 -> TikTok 字段名 (Canonical name -> TikTok field)
AUTHOR_FIELD_MAP = {
    "nickname": "nickname",
    "nickname_raw": "nickname_raw",
    "author_id": "uid",
    "author_handle": "uniqueId",
    "work_id": "aweme_id",
...
AUTHOR_URL_TEMPLATES = {
    "author_url": "https://www.tiktok.com/@{author_handle}",
    "work_url": "https://www.tiktok.com/@{author_handle}/video/{work_id}",
}
...
def format_author_file_name(naming_template: str, aweme_data: dict) -> str:
    ...
    Args:
        ...
        aweme_data (dict): TikTok 数据的字典 (dict of tiktok data)
